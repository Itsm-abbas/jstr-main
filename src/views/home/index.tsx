...
import WheelComponent, { type } from "react-wheel-of-prizes";
...
export const HomeView: FC = ({}) => {
  ...
  const onFinished = (winner: SetStateAction<string>) => {
    setAnswer(winner);
  };
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex flex-col">
        ...
        <div className="input-section flex flex-col mt-2">
          <label>Prize : {answer}</label>
          <RequestAirdrop />
